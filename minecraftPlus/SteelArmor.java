...
public class SteelArmor extends ItemArmor {
	...
	public SteelArmor(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (this.armorType == 2) {
			return "mp:textures/models/armor/dark_layer_2.png";
		}
		return "mp:textures/models/armor/dark_layer_1.png";
	}
