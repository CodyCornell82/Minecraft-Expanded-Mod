...
public class SilverSpawn extends Block {

	protected SilverSpawn(Material p_i45394_1_) {
		super(p_i45394_1_);
	...
	public void onBlockDestroyedByPlayer(World p_149664_1_, int p_149664_2_,
		...
		if (!p_149664_1_.isRemote) {
			Silver entitysilverfish = new Silver(p_149664_1_);
			...
			entitysilverfish.playSound("tile.piston.in", 1.0f, 1.0f);
		}
