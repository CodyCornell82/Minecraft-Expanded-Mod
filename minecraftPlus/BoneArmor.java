...
public class BoneArmor extends ItemArmor {
	...
	public BoneArmor(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (this.armorType == 2) {
			return "mp:textures/models/armor/bone_layer_2.png";
		}
		return "mp:textures/models/armor/bone_layer_1.png";
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
		...
		player.addPotionEffect(new PotionEffect(Potion.digSpeed
				.getId(), 25, 1, true));
		if (j > 0) {
