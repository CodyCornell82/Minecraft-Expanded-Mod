...
public class grayLeggings extends ItemArmor {

	public grayLeggings(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		return "mp:textures/models/armor/GrayLayer2.png";
	}
