...
public class ToxicSword extends ItemSword {

	public ToxicSword(ToolMaterial p_i45356_1_) {
		super(p_i45356_1_);
	...
	public boolean hitEntity(ItemStack stack, EntityLivingBase target,
		...
		// parameters of PotionEffect are: id, duration in ticks (20 = 1
		// second), and amplifier
		target.addPotionEffect(new PotionEffect(MinecraftPlus.Toxic.getId(),
				20 * 20, 1));
