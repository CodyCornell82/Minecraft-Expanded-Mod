...
public class TinArmor extends ItemArmor {
	...
	public TinArmor(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (this.armorType == 2) {
			return "mp:textures/models/armor/tin_layer_2.png";
		}
		return "mp:textures/models/armor/tin_layer_1.png";
	}
