...
public class CopperArmor extends ItemArmor {
	...
	public CopperArmor(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (this.armorType == 2) {
			return "mp:textures/models/armor/copper_layer_2.png";
		}
		return "mp:textures/models/armor/copper_layer_1.png";
	}
