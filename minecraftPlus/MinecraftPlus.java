...
@Mod(modid = "mp", name = "Minecraft Expanded", version = "2.4")
public class MinecraftPlus {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		CopperSword = new cobaltSword(Item.ToolMaterial.GOLD).setUnlocalizedName("Coppersword")
				.setTextureName("mp:CopperSword").setCreativeTab(ModItems);
		CopperPick = new cobaltPickaxe(Item.ToolMaterial.GOLD).setUnlocalizedName("Copperpick")
				.setTextureName("mp:CopperPick").setCreativeTab(ModItems);
		CopperAxe = new cobaltAxe(Item.ToolMaterial.GOLD).setUnlocalizedName("Copperaxe")
				.setTextureName("mp:CopperAxe").setCreativeTab(ModItems);
		CopperHoe = new cobaltHoe(Item.ToolMaterial.GOLD).setUnlocalizedName("Copperhoe")
				.setTextureName("mp:CopperHoe").setCreativeTab(ModItems);
		CopperShovel = new cobaltShovel(Item.ToolMaterial.GOLD).setUnlocalizedName("Coppershovel")
				.setTextureName("mp:CopperShovel").setCreativeTab(ModItems);
		TinSword = new cobaltSword(Item.ToolMaterial.IRON).setUnlocalizedName("Tinsword")
				.setTextureName("mp:TinSword").setCreativeTab(ModItems);
		TinPick = new cobaltPickaxe(Item.ToolMaterial.IRON).setUnlocalizedName("Tinpick")
				.setTextureName("mp:TinPick").setCreativeTab(ModItems);
		TinAxe = new cobaltAxe(Item.ToolMaterial.IRON).setUnlocalizedName("Tinaxe")
				.setTextureName("mp:TinAxe").setCreativeTab(ModItems);
		TinHoe = new cobaltHoe(Item.ToolMaterial.IRON).setUnlocalizedName("Tinhoe")
				.setTextureName("mp:TinHoe").setCreativeTab(ModItems);
		TinShovel = new cobaltShovel(Item.ToolMaterial.IRON).setUnlocalizedName("Tinshovel")
				.setTextureName("mp:TinShovel").setCreativeTab(ModItems);
...
.setUnlocalizedName("TinHelm")
.setTextureName("mp:tin_helmet").setCreativeTab(ModItems);
TinChestplate = new TinArmor(ItemArmor.ArmorMaterial.IRON, 0, 1)
.setUnlocalizedName("TinChest")
.setTextureName("mp:tin_chestplate")
.setCreativeTab(ModItems);
...
.setUnlocalizedName("TinBoots")
.setTextureName("mp:tin_boots").setCreativeTab(ModItems);
		...
		GameRegistry.registerItem(TinBoots, TinBoots.getUnlocalizedName()
				.substring(5));
		GameRegistry.registerItem(TinLeggings, TinLeggings
				.getUnlocalizedName().substring(5));
	...
	public void init(FMLInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ItemStack(itemGreyGem, 1), new Object[] {
				"RRR", "RSR", "RCR", 'R', Items.redstone, 'S', Blocks.stone, 'C', CopperIngot });
		...
		GameRegistry.addRecipe(new ItemStack(infuserOff, 1), new Object[] {
				...
				MinecraftPlus.grayPower, 'F', MinecraftPlus.fuelTank, 'T', TinIngot, 'C', Blocks.furnace });
...
.add(new ShapedOreRecipe(
	...
	GameRegistry.addRecipe(new ItemStack(CopperHelmet), new Object[] { "GGG",
			"G G", 'G', MinecraftPlus.CopperIngot });
	...
	GameRegistry.addRecipe(new ItemStack(CopperBoots), new Object[] { "G G",
			"G G", 'G', MinecraftPlus.CopperIngot });
...
GameRegistry.addRecipe(new ItemStack(TinPick),
		new Object[] { "GGG", " S ", " S ", 'G',
				MinecraftPlus.TinIngot, 'S', Items.stick });
