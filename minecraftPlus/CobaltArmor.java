...
public class CobaltArmor extends ItemArmor {
	...
	public CobaltArmor(ArmorMaterial armorMat, int rederIndex, int i) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot,
			String type) {
		if (this.armorType == 2) {
			return "mp:textures/models/armor/cobalt_layer_2.png";
		}
		return "mp:textures/models/armor/cobalt_layer_1.png";
	}
