...
public class MPPlank extends Block {
	public static final String[] field_150096_a = new String[] { "SilverPlank" };
	...
	public void getSubBlocks(Item p_149666_1_, CreativeTabs p_149666_2_,
			List p_149666_3_) {
		for (int i = 0; i < field_150096_a.length; i++) {
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		...
		for (int i = 0; i < this.field_150095_b.length; ++i) {
			this.field_150095_b[i] = p_149651_1_.registerIcon("mp:"
					+ field_150096_a[i]);
		}
	}
}
