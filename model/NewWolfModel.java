...
public class NewWolfModel extends ModelBase {
	...
	public NewWolfModel() {
		...
		this.wolfHeadMain.setTextureOffset(16, 14).addBox(-3.0F, -5.0F, 0.0F,
				2, 2, 1, f);
		this.wolfHeadMain.setTextureOffset(16, 14).addBox(1.0F, -5.0F, 0.0F, 2,
				2, 1, f);
		this.wolfHeadMain.setTextureOffset(0, 10).addBox(-1.5F, 0.0F, -5.0F, 3,
				3, 4, f);
	}
	...
	public void setLivingAnimations(EntityLivingBase p_78086_1_,
		...
		hellhound entitywolf = (hellhound) p_78086_1_;
		...
		this.wolfLeg3.setRotationPoint(-2.5F, 16.0F, -4.0F);
		this.wolfLeg4.setRotationPoint(0.5F, 16.0F, -4.0F);
		this.wolfLeg1.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F)
				* 1.4F * p_78086_3_;
		this.wolfLeg2.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F
				+ (float) Math.PI)
				* 1.4F * p_78086_3_;
		this.wolfLeg3.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F
				+ (float) Math.PI)
				* 1.4F * p_78086_3_;
		this.wolfLeg4.rotateAngleX = MathHelper.cos(p_78086_2_ * 0.6662F)
				* 1.4F * p_78086_3_;
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_,
		...
		this.wolfTail.rotateAngleX = -49.5f;
	}
}