...
public class RenderFeral extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("mp:"
			+ "textures/model/FeralMonster.png");

	protected TameMonster modelEntity;

	public RenderFeral(ModelBase p_i1262_1_, float p_i1262_2_) {
		super(p_i1262_1_, p_i1262_2_);

		modelEntity = ((TameMonster) mainModel);
	}

	public void renderTameMonster(FeralMonster entity, double x, double y,
	...
	public void doRenderLiving(EntityLiving liveMob, double x, double y,
			double z, float u, float v) {
		renderTameMonster((FeralMonster) liveMob, x, y, z, u, v);
	}

	public void doRender(Entity entity, double x, double y, double z, float u,
			float v) {
		renderTameMonster((FeralMonster) entity, x, y, z, u, v);
	}
