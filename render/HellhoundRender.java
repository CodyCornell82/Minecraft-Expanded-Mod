...
public class HellhoundRender extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("mp:"
			+ "textures/model/NewWolfTexture.png");

	protected NewWolfModel modelEntity;

	public HellhoundRender(ModelBase p_i1262_1_, float p_i1262_2_) {
		super(p_i1262_1_, p_i1262_2_);

		modelEntity = ((NewWolfModel) mainModel);
	}

	public void renderRobot(hellhound entity, double x, double y, double z,
			float u, float v) {
	...
	public void doRenderLiving(EntityLiving liveMob, double x, double y,
		...
		renderRobot((hellhound) liveMob, x, y, z, u, v);
	}

	public void doRender(Entity entity, double x, double y, double z, float u,
			float v) {
		renderRobot((hellhound) entity, x, y, z, u, v);
	}
