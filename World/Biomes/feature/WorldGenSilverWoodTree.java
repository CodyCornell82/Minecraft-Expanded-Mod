...
public class WorldGenSilverWoodTree extends WorldGenAbstractTree {
	...
	public WorldGenSilverWoodTree(Block wood, Block leaf, int metaWood,
			int metaLeaf) {
		this(wood, leaf, metaWood, metaLeaf, false, 4, 3, false);
	}

	public WorldGenSilverWoodTree(Block wood, Block leaf, int metaWood,
			int metaLeaf, boolean doBlockNotify, int minTreeHeight,
		...
		if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256) {
			...
			if (!flag) {
				...
				boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_,
						...
						(BlockSapling) MinecraftPlus.Sapling);
					...
					for (k1 = 0; k1 < l; ++k1) {
						...
						if (block.isAir(p_76484_1_, p_76484_3_,
							...
							this.setBlockAndNotifyAdequately(p_76484_1_,
									...
									MinecraftPlus.Log, this.metaWood);
