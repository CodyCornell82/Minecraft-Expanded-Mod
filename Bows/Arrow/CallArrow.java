package com.codycornell82.minecraftPlus.Bows.Arrow;
...
public class CallArrow extends Entity implements IProjectile {
	...
	public CallArrow(World p_i1753_1_) {
		super(p_i1753_1_);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public CallArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_,
			double p_i1754_6_) {
		super(p_i1754_1_);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public CallArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_,
	...
	public CallArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_,
			float p_i1756_3_) {
		super(p_i1756_1_);
		this.renderDistanceWeight = 10.0D;
		...
		this.setSize(0.5F, 0.5F);
		this.setLocationAndAngles(p_i1756_2_.posX, p_i1756_2_.posY
	...
	public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
		...
		this.field_145790_g = Block
				.getBlockById(p_70037_1_.getByte("inTile") & 255);
