package com.codycornell82.minecraftPlus.Bows.CallBow;
...
public class callBow extends Item {
	...
	public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_,
		...
		if (flag || p_77615_3_.inventory.hasItem(MinecraftPlus.VisberArrow)) {
			...
			CallArrow entityarrow = new CallArrow(p_77615_2_, p_77615_3_,
					f * 2.0F);
			...
			if (flag) {
				...
				p_77615_3_.inventory
						.consumeInventoryItem(MinecraftPlus.VisberArrow);
			}
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_,
		...
		if (p_77659_3_.capabilities.isCreativeMode
				|| p_77659_3_.inventory.hasItem(MinecraftPlus.VisberArrow)) {
	...
	public void registerIcons(IIconRegister p_94581_1_) {
		this.itemIcon = p_94581_1_.registerIcon("mp:bow_standby");
		this.iconArray = new IIcon[bowPullIconNameArray.length];

		for (int i = 0; i < this.iconArray.length; ++i) {
			this.iconArray[i] = p_94581_1_.registerIcon("mp:bow_"
