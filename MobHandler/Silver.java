...
public class Silver extends EntityTameable {
	private float field_70926_e;
	private float field_70924_f;

	private boolean field_70928_h;

	public Silver(World p_i1696_1_) {
		super(p_i1696_1_);
	...
	protected void func_145780_a(int p_145780_1_, int p_145780_2_,
		...
		this.playSound("mp:Silver.step", 0.15F, 1.0F);
	}
	...
	protected String getLivingSound() {
		return this.isAngry() ? "mp:Silver.mad"
				: (this.rand.nextInt(3) == 0 ? (this.isTamed()
						&& this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "mp:Silver.say"
						: "mp:Silver.say")
						: "mp:Silver.say");
	}
	...
	public boolean interact(EntityPlayer p_70085_1_) {
		...
		if (itemstack != null
			...
			if (!this.worldObj.isRemote) {
				...
				Robot entitypigzombie = new Robot(this.worldObj);
		...
		if (this.isTamed()) {
			if (itemstack != null) {
				...
				if (itemfood == MinecraftPlus.SilverIngot
			...
			if (this.func_152114_e(p_70085_1_) && !this.worldObj.isRemote
				...
				&& itemstack.getItem() == MinecraftPlus.SilverIngot
				&& !this.isAngry()) {
			if (!p_70085_1_.capabilities.isCreativeMode) {
				--itemstack.stackSize;
			}
	...
	public Silver createChild(EntityAgeable p_90011_1_) {
		Silver entitywolf = new Silver(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal p_70878_1_) {
		if (p_70878_1_ == this) {
			...
			return false;
		} else if (!(p_70878_1_ instanceof Silver)) {
			return false;
		} else {
			Silver entitywolf = (Silver) p_70878_1_;
	...
	public boolean func_142018_a(EntityLivingBase p_142018_1_,
		...
		if (!(p_142018_1_ instanceof EntityCreeper)
			...
			if (p_142018_1_ instanceof Silver) {
				Silver entitywolf = (Silver) p_142018_1_;
	...
	protected Item getDropItem() {
		return MinecraftPlus.SilverIngot;
	}
