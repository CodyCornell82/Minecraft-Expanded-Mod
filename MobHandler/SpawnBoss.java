...
public class SpawnBoss extends EntityMob implements IBossDisplayData {

	public SpawnBoss(World world) {
		super(world);
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
		...
		for (k = 0; k < j; ++k) {
			this.dropItem(MinecraftPlus.FireSword, 1);
		}
	}
	...
	protected void dropRareDrop(int p_70600_1_) {
		...
		case 0:
			this.dropItem(MinecraftPlus.CobaltBar, 4);
			break;
		case 1:
			this.dropItem(MinecraftPlus.RedQuartz, 4);
			break;
		case 2:
			this.dropItem(Items.netherbrick, 10);
			break;
		case 3:
			this.dropItem(Items.blaze_rod, 10);
		}
	}
	...
	public void onDeath(DamageSource p_70645_1_) {
		...
		if (p_70645_1_.getEntity() instanceof EntityPlayer) {
			...
			entityplayer.triggerAchievement(MinecraftPlus.BiggerDemons);
