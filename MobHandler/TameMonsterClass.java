...
public class TameMonsterClass extends EntityTameable {
	private float field_70926_e;
	private float field_70924_f;

	private boolean field_70928_h;

	public TameMonsterClass(World p_i1696_1_) {
		super(p_i1696_1_);
		...
		this.targetTasks.addTask(4, new EntityAITargetNonTamed(this,
				EntityHorse.class, 200, false));
		this.targetTasks.addTask(4, new EntityAITargetNonTamed(this,
				FeralMonster.class, 200, false));
	...
	protected String getLivingSound() {
		return this.isAngry() ? "mp:Tame.mad"
				: (this.rand.nextInt(3) == 0 ? (this.isTamed()
						&& this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "mp:Tame.say"
						: "mp:Tame.say")
						: "mp:Tame.say");
	}
	...
	public boolean interact(EntityPlayer p_70085_1_) {
		...
		if (itemstack != null
			...
			if (!this.worldObj.isRemote) {
				...
				EntityVillager entitypigzombie = new EntityVillager(
						this.worldObj);
		...
		if (this.isTamed()) {
			...
			if (this.func_152114_e(p_70085_1_) && !this.worldObj.isRemote
				...
				&& itemstack.getItem() == Items.gold_nugget && !this.isAngry()) {
			if (!p_70085_1_.capabilities.isCreativeMode) {
				--itemstack.stackSize;
			}
			...
			if (!this.worldObj.isRemote) {
				if (this.rand.nextInt(3) == 0) {
					...
					p_70085_1_.triggerAchievement(MinecraftPlus.Red);
				} else {
	...
	public TameMonsterClass createChild(EntityAgeable p_90011_1_) {
		TameMonsterClass entitywolf = new TameMonsterClass(this.worldObj);
	...
	public boolean canMateWith(EntityAnimal p_70878_1_) {
		if (p_70878_1_ == this) {
			...
			return false;
		} else if (!(p_70878_1_ instanceof TameMonsterClass)) {
			return false;
		} else {
			TameMonsterClass entitywolf = (TameMonsterClass) p_70878_1_;
	...
	public boolean func_142018_a(EntityLivingBase p_142018_1_,
		...
		if (!(p_142018_1_ instanceof EntityCreeper)
			...
			if (p_142018_1_ instanceof TameMonsterClass) {
				TameMonsterClass entitywolf = (TameMonsterClass) p_142018_1_;

				if (entitywolf.isTamed()
						&& entitywolf.getOwner() == p_142018_2_) {
					return false;
				}
			}
