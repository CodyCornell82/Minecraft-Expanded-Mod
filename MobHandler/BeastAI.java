...
public class BeastAI extends EntityMob {

	public BeastAI(World world) {
		super(world);
	...
	protected String getHurtSound() {
		return "mp:beast.hurt";
	}

	protected String getDeathSound() {
		return "mp:beast.death";
	}
	...
	protected void dropRareDrop(int p_70600_1_) {
		...
		case 0:
			...
			break;
		case 1:
			this.dropItem(MinecraftPlus.berry, 4);
			break;
		case 2:
